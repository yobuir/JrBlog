<?php 
$selectallusers=mysqli_query($con,"SELECT * FROM users,follow where users.unique_id!='$user_identity' and  follow.follower !='$user_identity' and follow.follow=0   ORDER BY RAND()
LIMIT 2");
		if ($selectallusers) {
